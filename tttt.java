...
public class EmailServlet {
	...
	private static String to = request.getParameter("email");
	private static String location=request.getParameter("location");
	private static String date=request.getParameter("date");
	private static String start=request.getParameter("start");
	private static String end=request.getParameter("end");
